    ...
    return (
        <div className="max-w-4xl mx-auto py-10">
            <div className="mb-12 text-center">
                <div className="inline-flex p-4 bg-primary/10 rounded-3xl border border-primary/20 mb-6 shadow-[0_0_40px_rgba(245,158,11,0.1)]">
                ...
                <p className="text-text-muted mt-2 text-sm font-medium">
                    Expand your universe with a new addition to the collection.
                </p>
            </div>
